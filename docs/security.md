...
- Gateway invocation is limited to the App Hosting and Functions runtimes plus the keyless CI deployment identity used for authenticated post-deployment smoke tests; no public invoker binding is granted.
